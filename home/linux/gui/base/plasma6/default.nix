...
in {
  ...
  home.activation.ensureDolphinrc = lib.hm.dag.entryAfter ["writeBoundary"] ''
    ${pkgs.rsync}/bin/rsync -avz --chmod=D2755,F744 ${./dotfiles_writable/dolphinrc} ${config.xdg.configHome}/dolphinrc
  '';
