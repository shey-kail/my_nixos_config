...
#  xdg.configFile."sunshine/".source = ./dotfiles/sunshine;

#  home.activation.sunshine = lib.hm.dag.entryAfter ["writeBoundary"] ''
#    ${pkgs.rsync}/bin/rsync -avz --chmod=D2755,F744 ${./sunshine_config}/ ${config.xdg.configHome}/sunshine/
#  '';
}
